...
@WebServlet(urlPatterns = {"/workOrder", "/workOrderDel", "/workOrderRetouch", "/workSafety", "/workSafetyDel", "/workSafetyRetouch", "/workQuality", "/workQualityDel", "/workQualityRetouch", "/facilityUpdate"})
public class WorkOrderServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if( local.equals("/workOrder") || local.equals("/workSafety") || local.equals("/workQuality") || local.equals("/facilityUpdate") ) {
			...
			System.out.println("facilitySeq : " + facilitySeq);
			System.out.println("facilityDetail : " + facilityDetail);
		...
		} else if( local.equals("/workOrderRetouch") || local.equals("/workSafetyRetouch") || local.equals("/workQualityRetouch") ) {
