...
<body>
			...
			<section>
				<article>
					<div class="work-safety-main">
						<form method="post" action="workSafety/delete">
							...
							<div class="safety-add-popup-content">
								...
								<div class="add-note">
									...
									<textarea id="add-detail" class="add-detail" name="w_detail"
										rows="5" cols="50" placeholder="내용 입력란(줄바꿈시 엔터)"></textarea>
								</div>
									...
									<div class="img-preview-box">
										<div class="addImgBox">
											<input type="text" id="add-img" name="w_img"> <input
												type="file" id="add-img-button" class="img-button"
												type="file" style="display: none;" name="w_imgFile">
											<label for="add-img-button" id="file-button">파일선택</label> <span
					...
					<form method="post" action="workSafety/update"
						enctype="multipart/form-data">
							...
							<div class="retouch-popup-content">
								...
								<div class="retouch-note">
									...
									<textarea id="retouch-detail" class="add-detail"
										name="w_detail" rows="5" cols="50" placeholder="내용 입력란"></textarea>
								</div>
									...
									<div class="img-preview-box">
										<div class="addImgBox">
											<input type="text" id="retouch-img" name="w_img"> <input
												...
												type="file" style="display: none;" name="w_imgFile">
											<label for="add-img-button" id="retouch-file-button">파일선택</label>
											<span id="updateFileName">선택된 파일 없음</span>
											<button type="button" id="img-retouch-button"
												class="img-select-button">사진선택</button>
										</div>
										<div id="retouch-img-preview">이미지 없음</div>
									</div>
								</div>
	...
	<script src="${pageContext.request.contextPath}/js/workSafety.js"></script>
</body>
