                ...
                <article id="article-container">
                    <div id="article-work-main">
                        ...
                        <div id="add-button-div">
                            ...
                            <button type="button" id="list-delete" class="list-delete-button">삭제하기</button>
                            ...
                            <div class="quality-list">
                                <div class="quality-order">
                                    <p>
                                        품질검사
                                        <br>
                                        각각의 체크사항에서 사진을 제시해서 시각적으로 작업자가 쉽게 파악하도록 유도한다
                                        <br><br>
                                        1. 외관체크
                                        <br><br>
                                        케이스 외관 확인 사항
                                        <br>
                                        양품 사진 첨부 위 아래 좌 우 정도
                                        <br>
                                        체크사항
                                        <br>
                                        도장상태
                                        <br>
                                        도장 까짐이 있는지 확인해준다 기본 도장은 블랙과 화이트 두가지
                                        <br>
                                        금형상태
                                        <br>
                                        눌리거나 휜곳이 있는지 확인
                                        ...
                                        2.전원부
                                        <br><br>
                                        전원부 예시 사진)led 파란색 점등 정상부팅 붉은색 부팅 오류
                                        <br>
                                        팬 회전 여부
                                        <br>
                                        팬등의 소음
                                        <br><br><br>
                                        3.윈도우 설치및 구동(윈도우 설치법 첨부)
                                        <br><br>
                                        체크사항
                                        <br><br>
                                        윈도우즈
