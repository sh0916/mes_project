...
<head>
    ...
    <title>Work Safety Page</title>
    <script src="workSafety.js"></script>
    <style>
        @font-face {
        ...
        .work-safety-title .work-safety-order {
            text-align: center;
            width: 100%;
        }

        .work-safety-list-zip {
            width: 100% !important;
...
<body>
    ...
    <div class="wrap">
        ...
        <div class="aside-section-container">
            ...
            <section>
                <article>
                    <div class="work-safety-main">
                    	<form method="post" action="workSafetyDel">
                    	
	                        <div id="work-safety-content" class="work-safety-content">
	
	                            <div class="work-safety-title">
	                                <div class="work-safety-order">
	                                    <h3>안전지침서</h3>
	                                </div>
	                            </div>
	                            <div class="work-safety-list-zip">
	                                <div class="work-safety-list">
	                                    <div class="work-ann">
	                                        <h4>
	                                            안전 지침서는 다음과 같습니다
	                                        </h4>
	                                ...
	                                <%	
	                                   	for(int i = 0; i < list.size(); i++) {
	                                    	...
	                                    	String urlImage = list.get(i).getUrlImage();
	                                ...
	                                <div class="work-safety-list">
	                                    <div class="delete-safety-checkbox">
	                                        <input type="checkbox" class="delete-safety-check" name="delCheck" value="<%= seq %>">
	                                    </div>
	                                    <div class="work-safety-order">
	                                        <p class="w_title">
						                    	<%= title %>
	                                    ...
	                                    <div class="work-safety-img">
	                                        <img
	                                        	src="<% if(urlImage == null) {
		                                        	%>
		                                        	https://image.spreadshirtmedia.net/image-server/v1/compositions/T996A1PA2179PT10X17Y18D172654919W7098H6789/views/1,width=550,height=550,appearanceId=1,backgroundColor=FFFFFF,noPt=true/pixel-art-fox-fox-podstawki.jpg
		                                        	<%
		                                        	} else {	                                            		
		                                    		%>
		                                    		<%= urlImage %>
                        ...
                        <div class="safety-user-button-div">
                            <button type="button" id="admin-change-button" class="admin-change-button">관리자</button>
                        </div>

                    </div>
	
					<form method="post" action="workSafety">
	                    <div id="safety-add-popup" class="add-popup">
	                        <div class="safety-add-popup-content">
	                            <h2>안전지침 체크사항 추가하기</h2>
	                            <div class="add-note">
	                                <p>추가할 제목</p>
	                                ...
	                                <textarea id="add-detail" class="add-detail" name="detail" rows="5" cols="50"
	                                    placeholder="내용 입력란(줄바꿈시 엔터)"></textarea>
	                            </div>
	                            ...
	                            <div class="img-note">
	                                ...
	                                <div class="img-preview-box">
	                                    <div class="addImgBox">
	                                        <input type="text" id="add-img" name="urlImage">
	                       ...
	                       <div id="order-retouch-popup" class="retouch-popup">
	                           <div class="retouch-popup-content">
	                               ...
	                               <div class="img-note">
	                                   ...
	                                   <div class="img-preview-box">
	                                       <div class="addImgBox">
	                                           <input type="text" id="retouch-img" name="urlImage">
	                                           <input type="file" id="add-img-button" class="img-button" type="file"
	                                               style="display: none;" name="add-img-button">
	                                           <label for="add-img-button" id="file-button">파일선택</label>
	                                           <span id="fileName">선택된 파일 없음</span>
